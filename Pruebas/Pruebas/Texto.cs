...
namespace Pruebas
{
    internal class Texto
    {
        ...
        public static String titulo = "\t\t***Coffin Opener*** \n\n";

        public String menu1 = titulo + "1) Jugar \n" +
                              "2) Cómo jugar \n" +
                              "3) Salir";

        public String menu2 = titulo + "Elija la cantidad de cofres entre 3 y 25:";
